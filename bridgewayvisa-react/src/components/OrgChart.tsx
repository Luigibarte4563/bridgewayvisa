...
import orgChart from "../../../assets/Team/ORGANIZATION CHART FINAL VERSION.webp";
...
export default function OrgChart() {
  ...
  return (
    <>
                ...
                <div className="bg-red-700 hover:bg-red-600 text-white font-medium px-5 py-2.5 rounded-lg shadow-lg flex items-center gap-2 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                  ...
                  >
                    <path
                      ...
                      d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.603 10.601zM10.5 7.5v6m3-3h-6"
                    />
                  </svg>
                  View Full Picture
                </div>
      ...
      {modalOpen && (
        <div
          className="fixed inset-0 z-50 bg-zinc-950/95 backdrop-blur-md flex flex-col p-4 md:p-8 select-none"
          role="dialog"
          aria-modal="true"
        >
          ...
          >
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 bg-zinc-900/90 border border-zinc-800 backdrop-blur-md px-4 py-2 rounded-xl flex items-center gap-3 shadow-2xl pointer-events-auto">
              ...
              <span className="text-xs font-mono font-bold text-zinc-300 min-w-[50px] text-center">
              ...
              <button
                onClick={resetZoom}
                className="text-xs font-medium text-zinc-400 hover:text-red-500 px-2 py-1 hover:bg-zinc-800/50 rounded-md transition-colors"
              >
                Reset
              </button>
            </div>
